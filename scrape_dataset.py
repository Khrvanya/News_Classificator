...
def scrape_categories(root_node, path, delete_previous=False):
    """
    Scrapes in my Node structure all nodes and their children 
    with scrape_query_news_articles() into the path
    """
    ...
    for node in root_node.children_set:
        scrape_categories(node, path, delete_previous)
